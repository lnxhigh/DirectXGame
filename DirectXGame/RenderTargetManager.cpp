...
bool RenderTargetManager::CreateRenderTarget(ID3D11Device* device, IDXGISwapChain* swap_chain)
{
...
bool RenderTargetManager::CreateDepthStencil(Window* window, ID3D11Device* device, IDXGISwapChain* swap_chain)
{
